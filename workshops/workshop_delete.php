...
//build query
$query_workshop = "DELETE FROM `workshops` WHERE `id` = ".$_GET['id'];

//echo $query;

//execute
$result = $db->exec($query_workshop);
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav navbar-right" style="padding-top: 10px">
                ...
                <li><a href="workshop_view.php">View Workshop</a></li>
                <li><a href="workshop_add.php">Add Workshop</a></li>
            </ul>
        </div>
    </div>
</nav>
        ...
        <div class="col-md-6 col-md-offset-3">
            <div class="panel panel-danger text-center">
                ...
                if($result){
                    ...
                    echo "<br>";
                    echo "Please Go back to Dashboard or Workshop Page.";
                }else{
                    echo "Sorry !";
                    echo "<br>";
