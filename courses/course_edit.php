...
<div class="container">
    <div class="row">
        <div class="col-md-6 col-md-offset-3">
            ...
            <form action="course_edit_done.php" method="post">
                <fieldset>
                    <legend>Edit Course Title </legend>

                    <input type="hidden" class="form-control" id="id" name="id" placeholder="ID"
                           value="<?=$courses['id'];?>">

                    <div class="form-group">
                        <label for="titles">Course Title :</label>
                        <input type="text" class="form-control" id="titles" name="titles"
                               placeholder="Enter Course Title" value="<?=$courses['titles'];?>">
                    </div>
