...
if(strtolower($_SERVER['REQUEST_METHOD']) == 'post') {
    ...
    foreach($course_ids as $course_id){
        $query = "INSERT INTO `maping_tables` ( `students_id`, `courses_id`) VALUES ( '".$_POST['student_id']."', '".$course_id."');";
        //echo $query."<br>";
        $db->exec($query);
    }
    //die();
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav navbar-right" style="padding-top: 10px">
                ...
                <li class="active"><a href="course_assign.php">Assign Course</a></li>
                            ...
                            <div class="form-group">
                                ...
                                <select name="course_ids[]" id="course_ids" class="form-control" >
                                    ...
                                    foreach($courses as $course):
                                        ...
                                        ?>
                                        <option value="<?=$course['id']?>"><?=$course['titles']?></option>
                                        <?php
                                    endforeach;
                                    ?>
