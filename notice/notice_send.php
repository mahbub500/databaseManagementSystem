...
//
////building query
$query = ' INSERT INTO `notice` (`date_publish`,`subjects`, `descriptions`, `sender`) 
 VALUES ("'.$_POST['date_publish'].'","'.$_POST['subjects'].'","'.$_POST['descriptions'].'","'.$_POST['sender'].'")';
    ...
    <div class="row">
        <div class="col-md-6 col-md-offset-3">
            <div class="panel panel-danger text-center">
                <?php
                if($result){
                    echo "Notice has been successfully send.";
                    echo "<br>";
                    echo "Thanks.";
                }else{
                    echo "Sorry !";
