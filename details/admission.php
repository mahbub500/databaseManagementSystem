    ...
    <div class="container">
        <div class="row">
            <div class="header-section text-center">
                <h2 class="white">How To Get Admission?</h2>
                <p class="white">Read the following steps.</p>
            ...
            <div class="col-md-10 col-md-offset-1">
                <div class="text-comment">
                    ...
                    <p>
                        ...
                        During registration all applicant has to provide following information:
                        ...
                        <br>
                        5.MCQ test day:
                        Each & every selected student has performed MCQ test at BASIS.
                        <br>
                        6.Short-listing based on MCQ Test:
                        Shortlisting the applicant for interview based on exam performance.
                        <br>
                        7.Notify the student by SMS & Email for Interview:
                        It is time to notify the selected student by SMS & email for Interview.
                        <br>
                        8.Interview day:
                        Each & every selected student has to perform interview at BASIS
                        <br>
                        9.Short-listing for Training based on Interview performance:
