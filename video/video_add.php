    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav navbar-right" style="padding-top: 10px">
                ...
                <li class="active"><a href="video_add.php">Add Video</a></li>
            </ul>
        </div>
    </div>
</nav>
...
<div class="container">
    ...
    <div class="row" style="height: 600px">
        <div class="col-md-10 col-md-offset-1">
            ...
            <form action="video_add_done.php" method="post">
                Title:
                <input name="title" type="text" class="form-control" placeholder="Enter Title" required>
                <br>
                Video Link:
                <input name="link" type="text" class="form-control" placeholder="Enter Only Embedded src attribute link" required >
                <br>
