                ...
                <li class="treeview active">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li>
                            ...
                            <ul class="treeview-menu">
                                <li class="active"><a href="../video/video_view_students.php"><i class="fa fa-play"></i> View All Video</a></li>
                            </ul>
                        </li>
                        <li>
                            ...
                            <ul class="treeview-menu">
                                <li><a href="../video/video_view_admin.php"><i class="fa fa-play"></i> View All Content</a></li>
                            </ul>
                        </li>
                    </ul>
                </li>
                    ...
                    <!--mail box ===================================================-->
                        ...
                        <div class="container">
                            <div class="row" style="height: 600px">
                                <div class="col-md-10  for_height">
                                    <div class="pannel panel-success">
                                        <div class="panel-heading">
                                            <p> <?php  echo $videos['title'];  ?></p>
                                        </div>
                                        <div class="pannel-body">
                                            <iframe src="<?php   echo $videos['link']; ?>" frameborder="1"style="width:945px;height:600px"></iframe>
                                        </div>
