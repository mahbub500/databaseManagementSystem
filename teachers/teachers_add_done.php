...
////building query
$query = 'INSERT INTO `teachers` (`image`, `names`, `emails`, 
                                  `phones`, `educations`, `experiences`) 
          VALUES ("'.$image.'","'.$_POST['names'].'","'.$_POST['emails'].'",
                  "'.$_POST['phones'].'","'.$_POST['educations'].'","'.$_POST['experiences'].'")';
