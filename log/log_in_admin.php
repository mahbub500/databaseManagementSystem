                    ...
                    if($_SESSION["user"] != '')
                    {
                        ...
                        echo "<li class=\"dropdown\">
                                  ...
                                  <ul class=\"dropdown-menu\">
                                      <li class='active'><a href=\"log_in_admin.php\">Log in as Admin</a></li>
                                      <li role=\"presentation\" class=\"divider\"></li>
                                      <li><a href=\"log_in_student.php\">Log in as Student</a></li>
                                  </ul>
                              </li>";
...
<!--                        <li class="active"><a href="log_in_admin.php">Log in as Admin</a></li>-->
<!--                        <li role="presentation" class="divider"></li>-->
<!--                        <li><a href="log_in_sutdent.php">Log in as Student</a></li>-->
<!--                    </ul>-->
<!--                </li>-->
<!---->
<!--                <li><a href="#">Log Out</a>-->
    ...
    <div class="row main">
        <div class="panel-heading">
            <div class="panel-title text-center">
                <h1 class="title">Log IN As An Admin</h1>
                <hr />
            </div>

        </div>
        <div class="main-login main-center">
            <form class="form-horizontal" method="post" action="check_admin.php">
...
<!--                </div>-->
    ...
    <hr>
    <div class="well">
        <h4 align="center">Log in, and manage your tasks through admin panel...</h4>
    </div>
</div>
