...
<!--                </li>-->
              ...
              <small class="label pull-right bg-yellow">View</small>
                ...
                <li class="active">
                    ...
                    <ul class="treeview-menu">
                        <li class="active"><a href="../feedback/feedback_write.php"><i class="fa fa-edit"></i>Write Feedback</a></li>
                    </ul>
                </li>
            ...
            <div class="row">
                <div class="col-md-9 col-md-offset-1">
                    <div class="header-section text-center">
                        <h2>Write feedback and send to us.</h2>
                        <p>You can suggest us by sending your feedback. We are waiting.</p>
                        <hr class="bottom-line">
                    </div>
                    <form action="feedback_send.php" method="post">
                        <input name="subjects" type="text" class="form-control" placeholder="Enter feedback subject here." required>
                        <br>
                        <textarea name="descriptions" type="text" class="form-control" cols="30" rows="10" placeholder="Enter  Description" required>
                        </textarea>
                        <br>
                        <input name="sender_seip_id" type="number" class="form-control" placeholder="Enter your SEIP ID here." required>
                        <br>
