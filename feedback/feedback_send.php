...
//
////building query
$query = ' INSERT INTO `feedback` ( `subjects`, `descriptions`, `sender_seip_id`) 
 VALUES ("'.$_POST['subjects'].'","'.$_POST['descriptions'].'","'.$_POST['sender_seip_id'].'")';
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav navbar-right" style="padding-top: 10px">
                ...
                <li><a href="feedback_write.php">Write Feedback</a></li>
            </ul>
        </div>
    </div>
</nav>
    ...
    <div class="row">
        <div class="col-md-6 col-md-offset-3">
            <div class="panel panel-danger text-center">
                <?php
                if($result){
                    echo "Feedback has been successfully send.";
                    echo "<br>";
                    echo "Thanks.";
                }else{
                    echo "Sorry !";
