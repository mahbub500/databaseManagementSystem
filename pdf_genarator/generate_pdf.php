...
function Header()
{
    ...
    $this->Cell(80);
    // Title
    $this->Cell(100,10,'Workshop Registered Student List',1,0,'C');
    // Line break
    $this->Ln(20);
}
...
$display_heading = array('id'=>'Name', 'employee_name'=> 'Father Name', 'employee_age'=> 'Mobile','employee_salary'=> 'Course',);


$result = mysqli_query($connString, "SELECT  name, fatherName,course, mobile  FROM workshops_registration") or die("database error:". mysqli_error($connString));
