        ...
        <div class="col-md-8 col-md-offset-2 for_height">
            <div class="pannel panel-success">
                <div class="panel-heading">
                    <h1 class="text-center"><i class="<?php echo $seip_course['icons']?>"></i> <?php  echo $seip_course['titles'];?></h1>
					
				</div>
                <div class="pannel-body">
					<h4>Start's from: </h4><p><?php echo $seip_course['times'];?></p>
                    <h4>Trainer: </h4><p><?php echo $seip_course['trainers'];?></p>
                    <h4>Prerequisite: </h4><p><?php echo $seip_course['prerequisite'];?></p>
                    <h4>Details about the course: </h4><p><?php echo $seip_course['descriptions'];?></p>
                </div>
